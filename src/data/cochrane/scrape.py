...
parser = argparse.ArgumentParser(prog='Cochrane Reviews Scraper', description='Scraper for Cochrane reviews')
parser.add_argument('type', choices=['dois', 'articles', 'content'], help='Which data type should be scraped (dois/articles/content?)')
